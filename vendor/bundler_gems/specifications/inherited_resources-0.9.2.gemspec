...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/respond_to_test.rb", "test/customized_belongs_to_test.rb", "test/nested_belongs_to_test.rb", "test/base_test.rb", "test/redirect_to_test.rb", "test/has_scope_test.rb", "test/class_methods_test.rb", "test/association_chain_test.rb", "test/aliases_test.rb", "test/flash_test.rb", "test/url_helpers_test.rb", "test/belongs_to_test.rb", "test/customized_base_test.rb", "test/polymorphic_test.rb", "test/defaults_test.rb", "test/singleton_test.rb", "test/optional_belongs_to_test.rb", "test/test_helper.rb"]
